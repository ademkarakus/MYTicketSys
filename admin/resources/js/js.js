...
function checkUncheckSome(controller,theElements) {
	...
	$.datepicker.regional['tr'] = {
        ...
        dayNamesShort: ['Pz','Pt','Sa','Ça','Pe','Cu','Ct'], dayNamesMin: ['Pz','Pt','Sa','Ça','Pe','Cu','Ct'],
...
$(function() {
		...
		$(".sil").button({icons: {primary: "ui-icon-close"},text: false	});
		$(".gncll").button({icons: {primary: "ui-icon-pencil"},text: false})
		$( "#tarih" ).datepicker();
		...
		$('.dataTable').dataTable({
			...
			"oLanguage": {
				...
				"sProcessing":"İşleniyor...","sLengthMenu":"Sayfada _MENU_ Kayıt Göster",

				"sZeroRecords":"Eşleşen Kayıt Bulunmadı",

				"sInfo":"  _TOTAL_ Kayıttan _START_ - _END_ Arası Kayıtlar",

				"sInfoEmpty":"Kayıt Yok","sInfoFiltered":"( _MAX_ Kayıt İçerisinden Bulunan)",

				"sInfoPostFix":"","sSearch":"Bul:","sUrl":"",
...
function sil(data,basarili,basarisiz){
